...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Nov-2019 às 17:00
...
--
-- Criação: 26-Nov-2019 às 11:42
-- Última actualização: 26-Nov-2019 às 15:49
--
...
CREATE TABLE `tb_evento` (
  ...
  `usuario_cads` varchar(1000) COLLATE utf8_unicode_ci DEFAULT NULL
...
INSERT INTO `tb_evento` (`id`, `id_usuario`, `nome`, `email`, `descricao`, `area`, `preco_evento`, `qntd_part`, `data_inicio`, `data_fim`, `estado`, `cidade`, `cep`, `data_cadastro`, `num_usuario_cads`, `usuario_cads`) VALUES
(5, 1, 'Teste Palestra', 'lucianolps08@gmail.com', 'Um teste de um evento de uma palestra', 'palestra', 10.00, 100, '24/11/2019', '25/11/2019', 'PI', 'Piripiri', 64260000, '2019-11-24 23:33:40', 1, '10#'),
(7, 1, 'Teste Minicurso', 'lucianolps08@gmail.com', 'Um teste de um evento de um Minicurso', 'minicurso', 2.00, 20, '24/11/2019', '30/11/2019', 'PI', 'Piripiri', 64260000, '2019-11-24 23:35:36', 1, '10#');
