...
--
-- Host: localhost:3306
-- Tempo de geração: 16/01/2020 às 21:29
...
(30, 35, 'um att', 20, 'pago', 2, 'Palestra', 20, '18/01/2020', '20/01/2020', '2020-01-16 18:47:45');
...
(32, 8, 'Um teste admin evento', 'lucianolps07@gmail.com', 'sjhcvbnlk', 'Palestra', 'ComputaÃ§Ã£o', 0.00, 20, '18/01/2020', '20/01/2020', 'Rua CapitÃ£o Manoel de Oliveira, 865', 'Recreio', 'PI', 'Piripiri', '64260-000', '2020-01-16 18:31:29', 0),
(35, 8, 'Um teste admin evento', 'lucianolps07@gmail.com', 'dksdjhskjsd', 'Palestra', 'ComputaÃ§Ã£o', 0.00, 50, '18/01/2020', '21/01/2020', 'Rua CapitÃ£o Manoel de Oliveira, 865', 'Recreio', 'PI', 'Piripiri', '64260-000', '2020-01-16 18:36:03', 0);
...
INSERT INTO `tb_inscricao` (`id_evento`, `id_usuario`, `papel`) VALUES
(5, 10, 2),
(7, 10, 2),
(20, 8, 2),
(8, 8, 2),
...
--
-- Estrutura para tabela `tb_papel_usuario`
--

CREATE TABLE `tb_papel_usuario` (
  `id` int(11) NOT NULL,
  `papel` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- RELACIONAMENTOS PARA TABELAS `tb_papel_usuario`:
--

--
-- Fazendo dump de dados para tabela `tb_papel_usuario`
--

INSERT INTO `tb_papel_usuario` (`id`, `papel`) VALUES
(1, 'administrador'),
(2, 'usuario');
...
--
-- Índices de tabela `tb_papel_usuario`
--
ALTER TABLE `tb_papel_usuario`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `tb_inscricao`
  ...
  ADD CONSTRAINT `tb_inscricao_ibfk_3` FOREIGN KEY (`papel`) REFERENCES `tb_papel_usuario` (`id`);
