<?php
    ...
    try {
        ...
        $query = '
        SELECT * FROM tb_evento left JOIN tb_inscricao ON(tb_evento.id=tb_inscricao.id_evento) 
        WHERE tb_inscricao.id_usuario = :id
        ';
        ...
        $eventos = $stmt->fetchAll(PDO::FETCH_OBJ); //PDO::FETCH_BOTH, _ASSOC, _NUM, _OBJ  S
        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" style="margin-top: 3.5em">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Eventos inscritos</li>
                </ol>
            </nav>
            <div class="container-fluid" style="margin-top: -3.8em">
                <h1 class="display-4 font-inicio"> Seus eventos inscritos</h1>
                <hr>
                <? foreach ($eventos as $evento) { ?>
                    <div class="card text-center mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <a href="./evento/?id=<?= $evento->id ?>" class="btn btn-primary">Visualizar informações do evento</a>
                        </div>
