        ...
        <div class="container-fluid">
            <nav aria-label="breadcrumb" style="margin-top: 3.5em">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Atividades do evento</li>
                </ol>
            </nav>
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        ...
                        <? if (!empty($atividades)) { ?>
                            ...
                            <? foreach($atividades as $att) { ?>
                                ...
                                <a href="../../../../controller/InscricaoAtividadeController.php?acao=inserir&id=<?=$_GET['id']?>&id_atividade=<?=$att->id?>" class="btn btn-primary">Inscrever-se na ativiade</a><hr><br><br>
                            <?}?>
                        <? } else { ?>
                            <div class="bg-center">
