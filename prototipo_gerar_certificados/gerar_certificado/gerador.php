...
$curso    = "(NOME DO CURSO OU EVENTO)";
$data     = "(DATA)";
$carga_h  = "(CARGA HORÁRIA)";
...
$texto3 = utf8_decode("Piaui, ".utf8_encode(strftime( '%d de %B de %Y', strtotime( date( 'Y-m-d' ) ) )));
...
$pdf->SetFont('Arial', '', 15); // Tipo de fonte e tamanho
$pdf->SetXY(205,175); //Parte chata onde tem que ficar ajustando a posição X e Y
